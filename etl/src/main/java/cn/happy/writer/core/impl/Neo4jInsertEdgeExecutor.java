package cn.happy.writer.core.impl;

import cn.happy.writer.core.Neo4jExecutor;
...
class Neo4jInsertEdgeExecutor implements Neo4jExecutor {
    ...
    public static final String HEAD_ALIAS = "head";
    public static final String TAIL_ALIAS = "tail";
    ...
    public void execute(Session session, Map<String, Object> queryMap) {
        ...
        Object headValue = queryMap.remove(HEAD_ALIAS);
        Object tailValue = queryMap.remove(TAIL_ALIAS);
